...
// To run the test:
// testdesc2 --server <servername> --uid <username> --pwd <userpassword> --dtb <databasename>
// NOTE: the database must exist before runnning the test.

#define RDD_NAME "SQLRDD"
#define TABLE_NAME "testdesc2"
#define NUM_REC 15
#define NUM_TIMES 1
...
PROCEDURE Main()
   ...
   IF !sr_ExistTable(TABLE_NAME)
      ...
      INDEX ON ID TO index4 DESCENDING
      INDEX ON NAME TO index5 DESCENDING
      INDEX ON DATE TO index6 DESCENDING
