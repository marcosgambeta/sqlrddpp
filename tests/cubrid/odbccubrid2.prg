...
// To run the test:
// odbccubrid2 --driver <drivername> --server <servername> --port <port> --uid <username> --pwd <userpassword> --database <databasename> -rdd <rddname> --tablename <tablename> --newtable --droptable --records <num_records>
