...
// To run the test:
// odbccubridcrud --driver <drivername> --server <servername> --port <port> --uid <username> --pwd <userpassword> --database <databasename> -rdd <rddname> --tablename <tablename> --newtable --droptable --records <num_records>
...
PROCEDURE Main()
   ...
   oTB:addColumn(TBColumnNew("#", {||(s_TABLE_NAME)->(recno())}))
